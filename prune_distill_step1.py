...
class MedSAM(nn.Module):
    ...
    def forward(self, image, box):
        ...
        image_embedding,_,_,_,_ = self.image_encoder(image)
...
def train_model():
    ...
    # student model
    model_type = 'vit_b'
    checkpoint = '/home/xinpeng/SlimSAM/checkpoints/medsam_vit_b_qkv.pth'
            ...
            for i in range(len(train_iter)):
                ...
                if i == len(train_iter)-1:
                    ...
                    if total_loss<=best_loss:
                        ...
                        filename = 'checkpoints/vit_b_medslim_final_step1_{ratio}'+'.pth'
